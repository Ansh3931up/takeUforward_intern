import logo from '../assets/logo.png'
 ...
 function Footer() {
  return (
    <><section className="relative overflow-hidden bg-blue-800 py-8">
      ...
      <div className="-m-8 flex flex-wrap items-center justify-between">
        ...
        <div className="w-auto p-8">
          <ul className=" flex flex-wrap items-center sm:text-sm">
            <li className="p-5">
              <a className="font-medium text-blue-50 hover:text-red-700" href="#">
                Privacy Policy
              </a>
            </li>
            <li className="p-5">
        ...
        <div className="w-auto p-8">
          <div className="-m-1.5 flex flex-wrap">
            <div className="w-auto p-1.5">
              <a href="#">
                <div className="flex h-8 w-8 items-center justify-center bg-blue-50 rounded-full border border-blue-50 hover:bg-blue-500">
                  <svg
                    width="8"
                    height="14"
                    viewBox="0 0 8 14"
            ...
            <div className="w-auto p-1.5">
              <a href="#">
                <div className="flex h-8 w-8 bg-blue-50 items-center justify-center rounded-full border border-blue-50 hover:bg-blue-500">
                  <svg
                    width="14"
                    height="11"
                    viewBox="0 0 14 11"
  ...
  <aside className="grid-flow-col items-center">
    ...
    <p>Copyright © ${new Date().getFullYear()} - All right reserved to thebeliever39@gmail.com</p>
  </aside>
